      ...
      <div className="space-y-8">
        <section>
          ...
          <form action={assignAction} className="flex gap-2 items-center">
            <select name="toId" className="border rounded-md px-3 py-2">
              {labLocations.map((l) => (
        ...
        <section>
          ...
          <form action={toTransferAction} className="flex gap-2 items-center">
            <select name="transferId" className="border rounded-md px-3 py-2">
        ...
        <section>
          ...
          <form action={toMainAction} className="flex gap-2 items-center">
            <select name="mainId" className="border rounded-md px-3 py-2">
              {nonLabLocations.map((l) => (
                <option key={l.Id} value={l.Id}>
                  {l.Name}
                </option>
